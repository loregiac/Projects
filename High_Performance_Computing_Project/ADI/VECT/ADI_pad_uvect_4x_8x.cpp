        ...
        void advance()
        {
            ...
            for (j=4; j < m; j=j+4) {
                ...
                for ( i = 1; i < m; i++) {
                    ...
                    __m256d rho2 = _mm256_loadu_pd(rho_ + i*M_padded + (j-3));
                    ...
                    _mm256_storeu_pd(rho_mid + (i)*M_padded + j-3,res);
                    _mm256_storeu_pd(b + 4*i-4,b3);
# 106 "ADI_pad_uvect_4x_8x.cpp"
                }



                __m256d rho2 = _mm256_loadu_pd(rho_ + m*M_padded + j-3);
                __m256d b2 = _mm256_loadu_pd(b + 4*nip -4 );
                __m256d res2 = _mm256_fmadd_pd(k2p,rho2,b2);
                _mm256_storeu_pd(b + 4*nip -4,res2);
# 125 "ADI_pad_uvect_4x_8x.cpp"
                rho2 = _mm256_loadu_pd(rho_mid + n*M_padded + (j-3));
